...
<div class="col-12">
          <div class="card">
              ...
              <div class="card-content">
                  <div class="card-body">
                      <form class="form form-horizontal" action="<?= base_url() ?>/daftar_berita/updateBerita/<?= $berita['id_berita'] ?>" method="post">
                          <div class="form-body">
                              <div class="row">
                                  <div class="col-md-3">
                                  ...
                                  <div class="col-md-9">
                                      <div class="form-group has-icon-left">
                                          <div class="position-relative">
                                              <input type="date" class="form-control mb-3 flatpickr flatpickr-input active" id="flatpickr" name='tanggal_berita' value="<?= $berita['tanggal_berita'] ?>" >
                                              <div class="form-control-icon">
