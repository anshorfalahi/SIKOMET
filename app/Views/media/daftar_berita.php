...
<div class="card-header">
  ...
  <?php endif; ?>
    <div class="card-body">
        <a href="<?= base_url() ?>/daftar_berita/tambah_berita" class="btn btn-primary btn-sm mb-3"><i class="bi bi-plus-circle"></i> Tambah Berita</a>
        ...
        <tbody>
          <?php $no = 1; foreach($listBerita as $berita): ?>
            <tr>
              ...
              <td>
                <a href="<?= base_url() ?>daftar_berita/ubah_berita/<?= $berita['id_berita'] ?>" class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i></a>
...
<div class="modal fade" id="delete<?= $berita['id_berita'] ?>" tabindex="-1" aria-labelledby="delete<?= $berita['id_berita'] ?>Label" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form action="<?= base_url() ?>daftar_berita/deleteBerita/<?= $berita['id_berita'] ?>" method="post">
