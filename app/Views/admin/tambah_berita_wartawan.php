...
<div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Tambah Berita Wartawan</h4>
            </div>
            <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" action="<?= base_url() ?>daftar_berita_wartawan/insertBerita" method="post">
                        <div class="form-body">
                            <div class="row">
                            <div class="col-md-3">
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <select class="form-control" name='id_wartawan' id="select-icons">
                                                <option value="" selected disabled>-- Pilih Nama Media --</option>
                                                <?php foreach($nama_media as $media): ?>
                                                    <option value="<?= $media['id_wartawan'] ?>"><?= $media['nama_media'] ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                    ...
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <select class="form-control" name="jenis_berita" id="jenis_berita">
                                                <option value="" selected disabled>-- Pilih Jenis Berita --</option>
